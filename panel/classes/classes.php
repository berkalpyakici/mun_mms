...
<? include(PATH_PRIVATE."page/classes.php"); ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<title><?= TITLE ?>: Class of <?= $localid ?></title>
...
<body>
  ...
  <? include(PATH_PRIVATE."page/navbar.php"); ?>
    ...
    <h3>Class of <?= $localid ?></h3>

    <? if($localempty) { ?>
      <div class="alert alert-danger">There are no members in the class of <?= $localid ?>.</div>
    <? } else { ?>
